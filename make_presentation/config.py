...
Для презентации на NUM_SL слайдов по теме \" THEME \" верни ответ строго в следующей форме:
...
Важно!!! Ответ не выделяй звездочками, решетками или другими символами.
"""
...
Верни ответ строго по следующей форме:
