...
1. Сгенерировать NUM_SLIDE заголовков для NUM_SLIDE слайдов в презентации по теме \" CONTEXT \".
...
Важно: слайды ведения и заключения не пиши.
4. На каждый из заголовков написать очень краткий информационный текст в несколько предложений
с важными датами, названиями и лицами (описание).
6. К каждому слайду придумать простое короткое описание для картинки людей, зданий, предметов,
которая будет изображена на слайде (картинка). Важно: это не должны быть графики или надписи.
